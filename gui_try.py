...
class TranslateBook(tk.Tk):
    def __init__(self):
        ...
        self.italian_copy_button = tk.Button(
            italian_tab, text="Copy to Clipboard", command=self.copy_to_clipboard)
        ...
        self.italian_label = tk.Label(
            italian_tab, textvar=self.italian_translation, bg="lightgrey", fg="black")
    ...
    def translate(self, target_language="mr", text=None):
        if not text:
        ...
        try:
            ...
            msg.showinfo("Translation Successful",
